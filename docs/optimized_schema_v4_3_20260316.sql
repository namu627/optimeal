-- ============================================================================
-- 비선형 AI 스케일링 모델 - 최적화된 DB 스키마 v4.1
-- ============================================================================
...
[모듈 2 - 비선형 스케일링 엔진] (12개)
 ...
 6. recipe                      레시피 마스터 (통합)
 7. recipe_ingredient_map       레시피-재료 매핑
...
SELECT '✅ DB 스키마 v4.3 생성 완료: 17개 테이블 (모듈 1+2+3 통합, 로드맵 v4.0 / ADR-001·002·003·ADR-002v3 반영)' AS status;
